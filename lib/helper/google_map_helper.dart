...
class GoogleMapHelper {
  static Future<BitmapDescriptor> getBitmapFromAsset(int width, String path) async {
  ...
  static Future<BitmapDescriptor> getBitmapFromCanvas(int width, int height, String path) async {
    ...
    canvas.drawImageRect(
      imaged,
      ui.Rect.fromLTRB(0.0, 0.0, imaged.width.toDouble(), imaged.height.toDouble()),
